...
import { usePaymentTypeChina } from "@/stores/overlay";
...
const ChinaTypeModal = ({ paymentList }: PaymentModalProps) => {
  const { open, setOpen, setPaymentDetails } = usePaymentTypeChina();
