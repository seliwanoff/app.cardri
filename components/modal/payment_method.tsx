...
const PaymentMethodModal = ({ paymentList }: PaymentModalProps) => {
  const { showMethod, setShowMethod, setPaymentMethodDetails } =
    usePaymentMethodOverlay();
  ...
  return (
    <Transition show={showMethod}>
      <Dialog className="relative z-10" onClose={setShowMethod}>
        <TransitionChild
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center overflow-hidden lg:p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <DialogPanel className="relative transform lg:rounded-[30px] w-full lg:min-h-auto min-h-[100vh-140px] bg-[#F5F2FB] px-4 pb-4 pt-5 text-left lg:pl-[30px] lg:pb-[30px] lg:pr-[30px] shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-[526px] sm:p-6">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <span className="text-[#6C757D] font-normal font-inter text-sm">
